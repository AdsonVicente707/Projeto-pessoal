...
router.route('/:id').get(protect, getSpaceById).put(protect, ensureUploadsDir, updateSpaceSettings).delete(protect, deleteSpace);
...
router.route('/:id/messages').get(protect, getSpaceMessages).post(protect, ensureUploadsDir, sendSpaceMessage);
